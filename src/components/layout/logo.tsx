    ...
    <Link href="/" className={`inline-flex items-center gap-3 group focus:outline-none ${className}`}>
      ...
      {variant === 'full' && (
        <div className="flex gap-1">
          <span className="font-poppins font-extrabold text-2xl tracking-tight text-white leading-none">
            NABS<span className="text-[#00A8FF]">.</span>
          </span>
          <span className="text-[13px] font-mono tracking-widest text-[#00E5FF] uppercase font-semibold mt-1">
            Marketing
          </span>
        </div>
      )}
